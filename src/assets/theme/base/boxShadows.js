/**
 * The base box-shadow styles for the Gravity UI Dashboard  Material.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire Gravity UI Dashboard  Material using thie file.
 */
