...
export default styled(Select)(({ theme, ownerState }) => {
  ...
  const outliedStyles = () => {
    ...
    // border color value
    let borderColorValue = palette[color] ? rgba(palette[color].main, 0.75) : "#26282d"

    if (color === "white") {
      borderColorValue = "#26282d"
    }
    ...
    const x = {
      ...
      borderColor: borderColorValue + "!important",
      ...
      "&:active:not(:hover)": {
        backgroundColor: colorValue + "!important",
  ...
  const textStyles = () => {
    ...
    return {
      ...
      "&:hover": {
        color: focusedColorValue + "!important",
      },
  ...
  return {
    ...{
      borderRadius: "8px !important", border: "1px solid #26282d !important", backgroundColor: "transparent !important",
      color: `${white.main} !important`
    },
