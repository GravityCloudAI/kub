...
export default styled(InputBase)(({ theme, ownerState }) => {
  ...
  const { size, error, success, iconDirection, direction, disabled, helperText } = ownerState;

  const { inputColors, white, grey, info, transparent } = palette;
  ...
  let borderColorValue = inputColors.borderColor.focus;
  ...
  return {
    ...
    '& + .MuiFormHelperText-root': {
      color: error ? inputColors.error : success ? inputColors.success : grey[400],
      fontSize: pxToRem(12),
      marginTop: pxToRem(4),
