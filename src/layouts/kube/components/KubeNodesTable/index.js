...
// Data
import parseActionsData from "layouts/kube/components/KubeNodesTable/data";

function KubeNodesTable(props) {
          ...
          <GuiBox mt="8px" mb="auto" display="flex" sx={{ gap: "8px" }}>
            <GuiBox display="flex" alignItems="center" lineHeight={0}>
              ...
              <GuiTypography variant="button" fontWeight="regular" color="text" ml="5px">
                &nbsp;<strong>{props.data.length === 1 ? props.data.length + " node" : props.data.length + " nodes"}</strong>
              </GuiTypography>
            </GuiBox>
          </GuiBox>
        </GuiBox>
