...
// Data
import parseActionsData from "layouts/kube/components/KubeDeploymentsTable/data";
import GuiButton from "components/GuiButton";

function KubeDeploymentsTable(props) {
          ...
          <GuiBox mt="8px" mb="auto" display="flex" sx={{ gap: "8px" }}>
            <GuiBox display="flex" alignItems="center" lineHeight={0}>
              ...
              <GuiTypography variant="button" fontWeight="regular" color="text" ml="5px">
                &nbsp;<strong>{props.data.length === 1 ? props.data.length + " deployment" : props.data.length + " deployments"}</strong>
              </GuiTypography>
            </GuiBox>
          </GuiBox>
        </GuiBox>
...
export default KubeDeploymentsTable;
