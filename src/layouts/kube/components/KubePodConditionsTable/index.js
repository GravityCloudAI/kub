...
// Data
import parseActionsData from "layouts/kube/components/KubePodConditionsTable/data";

function KubePodConditionsTable(props) {
  const { columns, rows } = parseActionsData(props);
...
export default KubePodConditionsTable;
